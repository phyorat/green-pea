...
//#define DEBUG	1
//#define DEBUG_USI_SPOOLER
//#define DEBUG_USI_SPOOLER_DEEP
...
#ifdef DEBUG
#define DEBUG_WRAP(code)	do{code;}while(0);
void DebugMessageFunc(int dbg,char *fmt, ...);
#ifdef HAVE_WCHAR_H
void DebugWideMessageFunc(int dbg,wchar_t *fmt, ...);
#endif
...
#ifdef DEBUG_USI_SPOOLER
  #define DEBUG_U_WRAP(code)	do{code;}while(0);
#else
  #define DEBUG_U_WRAP(code)
#endif

#ifdef DEBUG_USI_SPOOLER_DEEP
  #define DEBUG_U_WRAP_DEEP(code)	do{code;}while(0);
#else
  #define DEBUG_U_WRAP_DEEP(code)
#endif
