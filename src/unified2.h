...
typedef enum __unified2_serve_type
{
//SNORT DEFINES
//Long time ago...
    UNIFIED2_EVENT = 1,
...
//CURRENT
    ...
    UNIFIED2_IDS_EVENT_APPID = 111,
    UNIFIED2_IDS_EVENT_APPID_IPV6 = 112,
    UNIFIED2_IDS_EVENT_APPSTAT = 113,
...
void Unified2_Archive(Waldo *, uint32_t);
int Unified2DirAddWatch(char *, int *);
void* Unified2DirEvent(void *);
