...
#define BARNYARD2_READ_EMPTY    35
#define BARNYARD2_RING_FULL		36
...
/* Does not need cleanup */
    ...
    //char spool_dir[BY_MUL_TR_DEFAULT][MAX_FILEPATH_BUF];
    char waldo_filepath[MAX_FILEPATH_BUF];
...
/* Need to be handled by Barnyard2ConfFree() */
    ...
    Spooler *spooler[BY_MUL_TR_DEFAULT]; /* Used to know if we need to call spoolerClose */
